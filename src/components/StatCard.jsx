function StatCard({ label, value, suffix, variant = 'default', testId }) {
  const isGreen = variant === 'green'
  return (
    <div data-testid={testId} className={`border rounded-xl p-5 ${isGreen ? 'bg-[#edf5f0] border-[#c8dfd0]' : 'bg-white border-gray-200'}`}>
